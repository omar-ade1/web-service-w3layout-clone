    ...
    >
      <div className="container px-5 flex justify-evenly items-center mx-auto">
        ...
        >
          <li>
            <NavLink
              className="smT0:w-screen hover:bg-blue-200 dark:hover:bg-blue-500 block p-2 rounded"
              href="/"
            >
              home
            </NavLink>
        ...
        <div className=" search-bar relative smT0:hidden">
          <input
            type="text"
            placeholder="search here"
            className=" bg-white dark:bg-[#31363F] dark:border-[#76ABAE] border-2 px-2 py-1 rounded placeholder:capitalize"
          />
          <FontAwesomeIcon
            className=" absolute right-2 top-1/2 dark:text-[#76ABAE]  -translate-y-1/2"
            icon={faMagnifyingGlass}
          />
        </div>
