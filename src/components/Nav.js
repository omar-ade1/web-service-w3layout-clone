          ...
          {showLinks ? (
            <motion.ul
              ...
              className={`font-bold links mr-3 md:mr-1 flex space-x-3 md:space-x-1 capitalize ${
                showLinks
                  ? `smT0:absolute smT0:flex-col smT0:top-full smT0:left-0 smT0:bg-[#f44336de] dark:smT0:bg-[#607d8b] smT0:w-full smT0:text-center smT0:space-x-0  smT0:items-center smT0:gap-y-3`
                  : `smT0:hidden`
              } ${headerPadding ? `text-black dark:text-[#EEEEEE] ` : `text-white`} `}
            >
              ...
              <motion.li
                variants={variantsLi}
                className={`relative before:content-[''] before:absolute before:border-[10px]  before:border-x-transparent before:border-t-transparent before:border-b-white dark:before:border-b-[#31363F] before:top-[calc(100%+10px)] before:left-1/2 before:-translate-x-1/2 before:transition ${
                ...
                <AnimatePresence>
                  {show_menu_of_pages_nav && (
                    <motion.ul
                      ...
                      animate="show"
                      exit="exit"
                      className="menu shadow-2xl z-50 dark:shadow-md dark:shadow-white divide-y-2  absolute w-[200px] grid gap-y-2 text-center font-semibold  p-2 bg-white dark:bg-[#31363F] rounded top-[calc(100%+10px)] left-1/2 -translate-x-1/2"
                    >
                      <li>
                        <NavLink
              ...
              {showLinks ? (
                <motion.li variants={variantsLi} className=" w-2/3 hidden smT0:block search-bar relative">
                  <input
                    type="text"
