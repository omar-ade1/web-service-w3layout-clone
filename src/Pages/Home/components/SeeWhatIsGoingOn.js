            ...
            return (
              <div className="box shadow-xl rounded overflow-hidden">
                ...
                <div className="text p-3">
                  ...
                  <Link className="block border-b-2 w-fit capitalize mt-3 border-b-red-500 dark:border-b-[#007F73] transition-transform duration-300 text-[#d34588] font-bold hover:scale-110" to="/">read more</Link>
                </div>
              </div>
            );
          })}
